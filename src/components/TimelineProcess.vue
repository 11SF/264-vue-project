<template>
  <v-container class="mt-6">
    <h1 class="text-center">ขั้นตอนในการลงทะเบียน</h1>
    <v-timeline :dense="$vuetify.breakpoint.smAndDown">
      ...
      <v-timeline-item color="amber lighten-1" fill-dot left small>
        <v-card>
          ...
          <v-container>
            <v-row>
              <v-col cols="12" md="12">
                รออนุมัติจากอาจารย์ที่ปรึกษา เจ้าหน้าที่โครงการ อาจารย์ผู้สอน
                และ คณบดี
              </v-col>
            </v-row>
          </v-container>
      ...
      <v-timeline-item color="amber lighten-2" fill-dot right>
        <v-card>
          <v-card-title class="amber lighten-2 justify-end">
            <h2 class="display-1 mr-4 white--text font-weight-light">
              ชำระเงิน
            </h2>
            <v-icon dark size="42"> mdi-home-outline </v-icon>
          ...
          <v-container>
            <v-row>
              <v-col cols="12" md="12"> ชำระเงินผ่านระบบของธนาคาร </v-col>
            </v-row>
          </v-container>
        </v-card>
      </v-timeline-item>
